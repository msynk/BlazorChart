...
/// <c>BlazorChartScriptableContext</c>. A scriptable option is a <c>Func&lt;BlazorChartScriptableContext, T&gt;</c> that
/// is evaluated per data element, letting colors/radius/styles vary by value, index or state.
/// </summary>
public sealed class BlazorChartScriptableContext
{
    ...
    public BlazorChartType Type { get; init; }
}
