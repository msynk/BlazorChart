...
/// </summary>
public sealed class BlazorChartRadialGradient : BlazorChartGradientBase
{
    ...
    public BlazorChartRadialGradient() { }

    public BlazorChartRadialGradient(params BlazorChartGradientStop[] stops) => Stops.AddRange(stops);

    /// <summary>Convenience: a two-stop center→edge radial gradient.</summary>
    public static BlazorChartRadialGradient Center2(string center, string edge) =>
        new(new BlazorChartGradientStop(0, center), new BlazorChartGradientStop(1, edge));
}
