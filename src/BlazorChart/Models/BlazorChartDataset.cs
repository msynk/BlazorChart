...
/// <see cref="BlazorChartDataPoint"/> (<see cref="Points"/>) for scatter/bubble charts.
/// </summary>
public sealed class BlazorChartDataset
{
    ...
    public List<BlazorChartDataPoint>? Points { get; set; }

    /// <summary>Optional per-dataset type override for mixed charts.</summary>
    public BlazorChartType? Type { get; set; }
    ...
    public BlazorChartFillPattern? BackgroundPattern { get; set; }
    ...
    // ---- BlazorChartScriptable options (evaluated per element; take precedence over the constants above) ----
    /// <summary>BlazorChartScriptable background color: <c>ctx => color</c>.</summary>
    public Func<BlazorChartScriptableContext, string?>? BackgroundColorFn { get; set; }
    /// <summary>BlazorChartScriptable border color: <c>ctx => color</c>.</summary>
    public Func<BlazorChartScriptableContext, string?>? BorderColorFn { get; set; }
    /// <summary>BlazorChartScriptable border width: <c>ctx => width</c>.</summary>
    public Func<BlazorChartScriptableContext, double?>? BorderWidthFn { get; set; }
    /// <summary>BlazorChartScriptable point radius: <c>ctx => radius</c>.</summary>
    public Func<BlazorChartScriptableContext, double?>? PointRadiusFn { get; set; }
    /// <summary>BlazorChartScriptable point background color.</summary>
    public Func<BlazorChartScriptableContext, string?>? PointBackgroundColorFn { get; set; }
    /// <summary>BlazorChartScriptable point border color.</summary>
    public Func<BlazorChartScriptableContext, string?>? PointBorderColorFn { get; set; }
    /// <summary>BlazorChartScriptable point style.</summary>
    public Func<BlazorChartScriptableContext, BlazorChartPointStyle?>? PointStyleFn { get; set; }

    // ---- Line / radar element options ----
    public BlazorChartFillMode Fill { get; set; } = BlazorChartFillMode.None;
    public string? FillColor { get; set; }
    /// <summary>Optional gradient (linear or radial) used for the area fill (takes precedence over <see cref="FillColor"/>).</summary>
    public BlazorChartGradientBase? FillGradient { get; set; }
    /// <summary>Target dataset index when <see cref="Fill"/> is <see cref="BlazorChartFillMode.Dataset"/>.</summary>
    public int? FillTargetIndex { get; set; }
    /// <summary>Bezier curve tension (0 = straight lines).</summary>
    public double Tension { get; set; }
    /// <summary>Cubic interpolation mode. <see cref="BlazorChartCubicInterpolationMode.Monotone"/> avoids overshoot.</summary>
    public BlazorChartCubicInterpolationMode CubicInterpolationMode { get; set; } = BlazorChartCubicInterpolationMode.Default;
    public BlazorChartSteppedLine Stepped { get; set; } = BlazorChartSteppedLine.False;
    ...
    public BlazorChartLineSegmentStyle? Segment { get; set; }
    /// <summary>When <see cref="Fill"/> is <see cref="BlazorChartFillMode.Value"/>, the absolute axis value to fill to.</summary>
    ...
    public BlazorChartBorderRadiusCorners? BorderRadiusCorners { get; set; }
    ...
    public BlazorChartBorderSkipped BorderSkipped { get; set; } = BlazorChartBorderSkipped.Start;
