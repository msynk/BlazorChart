...
{
    public BlazorChartAnnotationKind Kind { get; set; } = BlazorChartAnnotationKind.Line;

    // Line
    public BlazorChartLineOrientation Orientation { get; set; } = BlazorChartLineOrientation.Horizontal;
