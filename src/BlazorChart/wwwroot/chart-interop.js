// BlazorChart pointer interop — used for responsive sizing (always) and zoom/pan (optional).
// Computes normalized cursor fractions and forwards wheel/drag gestures to .NET.
...
export function observe(element, dotnet) {
    let lastW = 0, lastH = 0;
    function report() {
...
export function register(element, dotnet, opts) {
    const state = { panning: false, lastX: 0, lastY: 0 };
